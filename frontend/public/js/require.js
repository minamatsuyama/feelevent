...
(function(ba) {
    ...
    function ga(b) {
        function c(a, j, b) {
            ...
            if (a) {
                ...
                l = a;
                for (c = 0; c < l.length; c++) if (d = l[c], "." === d) l.splice(c, 1), c -= 1; else if (".." === d && !(0 === c || 1 === c && ".." === l[2] || ".." === l[c - 1]) && 0 < c) l.splice(c - 1, 2), 
                c -= 2;
                a = a.join("/");
            }
            if (b && p && (j || m)) {
        ...
        function i(a, j, b, f) {
            ...
            a && (e ? m = d && d.normalize ? d.normalize(a, function(a) {
                return c(a, i, f);
            }) : -1 === a.indexOf("!") ? c(a, i, f) : a : (m = c(a, i, f), a = g(m), e = a[0], 
            m = a[1], b = !0, l = h.nameToUrl(m)));
        ...
        function s(a, j, b) {
            var f = a.id, c = n(m, f);
            if (t(q, f) && (!c || c.defineEmitComplete)) "defined" === j && b(q[f]); else if (c = r(a), 
            c.error && "error" === j) b(c.error); else c.on(j, b);
        }
        function w(a, b) {
        ...
        function D() {
            ...
            if (!W) {
                ...
                A(V, function(a) {
                    var h = a.map, g = h.id;
                    if (a.enabled && (h.isDefine || l.push(a), !a.error)) if (!a.inited && c) p(g) ? e = b = !0 : (f.push(g), 
                    d(g)); else if (!a.inited && (a.fetched && h.isDefine) && (e = !0, !h.prefix)) return i = !1;
                });
                if (c && f.length) return a = B("timeout", "Load timeout for module: " + f, null, f), 
                a.contextName = h.contextName, w(a);
                i && v(l, function(a) {
                    F(a, {}, {});
                });
    ...
    if ("undefined" === typeof define) {
        ...
        e.createNode = function(b) {
            var c = b.xhtml ? document.createElementNS("http://common.w3.org/1999/xhtml", "html:script") : document.createElement("script");
        ...
        z && !s.skipDataMain && T(document.getElementsByTagName("script"), function(b) {
            y || (y = b.parentNode);
            if (I = b.getAttribute("data-main")) return r = I, s.baseUrl || (E = r.split("/"), 
            r = E.pop(), O = E.length ? E.join("/") + "/" : "./", s.baseUrl = O), r = r.replace(Q, ""), 
